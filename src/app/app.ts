        ...
        <div class="container mx-auto px-6 relative z-10">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <ul class="space-y-3 text-sm">
                <li>
                  <a href="https://www.linkedin.com/in/mark-dave-camus-81a5193a4/" target="_blank" class="flex items-center gap-2 text-slate-400 hover:text-cyan-400 transition-colors group">
                ...
                <li>
                  <a href="https://github.com/Camusmarkdave" target="_blank" class="flex items-center gap-2 text-slate-400 hover:text-cyan-400 transition-colors group">
...
export class AppComponent implements OnInit {
  ...
  constructor() {
    ...
    this.router.events.pipe(
      ...
      let pageTitle = 'Mark Dave Camus | Web Developer & UI Engineer';
      if (url.includes('/about')) {
        pageTitle = 'About | Mark Dave Camus';
      } else if (url.includes('/projects')) {
        pageTitle = 'Projects | Mark Dave Camus';
      } else if (url.includes('/resume')) {
        pageTitle = 'Resume | Mark Dave Camus';
      } else if (url.includes('/contact')) {
        pageTitle = 'Contact | Mark Dave Camus';
      }
